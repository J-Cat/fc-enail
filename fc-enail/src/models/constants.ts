...
export const LOAD_SAVED_PROFILES = 'ENAIL/PROFILES/LOAD';
export const PERSIST_SAVED_PROFILES = 'ENAIL/PROFILES/PERSIST';
export const DELETE_PROFILE = 'ENAIL/PROFILE/DELETE';

export const SAVE_SCRIPT = 'ENAIL/SCRIPT/SAVE';
export const DELETE_SCRIPT = 'ENAIL/SCRIPT/DELETE';
